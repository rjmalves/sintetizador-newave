...
class OperationVariableBounds:
    ...
    def _earm_earp_ree_bounds(
        ...
        # Filtra pelas datas existentes na síntese
        df_earmax_ree = df_earmax_ree.loc[
            df_earmax_ree["data"].isin(datas_inicio)
        ]
        df_limite_inferior = df_limite_inferior.loc[
            df_limite_inferior["data"].isin(datas_inicio)
        ]
    ...
    def _earm_earp_sbm_bounds(
        ...
        # Filtra pelas datas existentes na síntese
        df_earmax_sbm = df_earmax_sbm.loc[
            df_earmax_sbm["data"].isin(datas_inicio)
        ]
        df_limite_inferior = df_limite_inferior.loc[
            df_limite_inferior["data"].isin(datas_inicio)
        ]
    ...
    def _earm_earp_sin_bounds(
        ...
        # Filtra pelas datas existentes na síntese
        df_earmax_sin = df_earmax_sin.loc[
            df_earmax_sin["data"].isin(datas_inicio)
        ]
        df_curva_sin = df_curva_sin.loc[
            df_curva_sin["data"].isin(datas_inicio)
        ]
