...
class Deck:
    ...
    def num_hydro_simulation_stages_policy(cls, uow: AbstractUnitOfWork) -> int:
        return _tmp.num_hydro_simulation_stages_policy(cls, cls._c(), uow, entities.eers(cls, cls._c(), uow))
    @classmethod
    def num_hydro_simulation_stages_final_simulation(cls, uow: AbstractUnitOfWork) -> int:
        return _tmp.num_hydro_simulation_stages_final_simulation(cls, cls._c(), uow, entities.eers(cls, cls._c(), uow))
    @classmethod
    ...
    def hydro_simulation_stages_ending_date_final_simulation(cls, uow: AbstractUnitOfWork) -> datetime:
        return _tmp.hydro_simulation_stages_ending_date_final_simulation(cls, cls._c(), uow, entities.eers(cls, cls._c(), uow))
    @classmethod
    ...
    def _stored_energy_upper_bounds_inputs(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _e.stored_energy_upper_bounds_inputs(cls, cls._c(), uow)
    @classmethod
    def _stored_energy_upper_bounds_pmo(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _e.stored_energy_upper_bounds_pmo(cls, cls._c(), uow)
    @classmethod
    def stored_energy_upper_bounds(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _e.stored_energy_upper_bounds(cls, cls._c(), uow)
    @classmethod
    ...
    def hydro_volume_bounds_in_stages(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _hy.hydro_volume_bounds_in_stages(cls, cls._c(), uow)
    @classmethod
    def hydro_volume_bounds_in_stages_for_rescaling(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _hy.hydro_volume_bounds_in_stages_for_rescaling(cls, cls._c(), uow)
    @classmethod
    ...
    @classmethod
    def hydro_turbined_flow_bounds_with_changes(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
    ...
    def hydro_turbined_flow_bounds_in_stages(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _hy.hydro_turbined_flow_bounds_in_stages(cls, cls._c(), uow)
    @classmethod
    ...
    def hydro_outflow_bounds_in_stages(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _hy.hydro_outflow_bounds_in_stages(cls, cls._c(), uow)
    @classmethod
    ...
    def _thermal_generation_bounds_pmo(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _th._thermal_generation_bounds_pmo(cls, cls._c(), uow)
    @classmethod
    def thermal_generation_bounds(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _th.thermal_generation_bounds(cls, cls._c(), uow)
    @classmethod
    ...
    def _initial_stored_energy_from_confhd_hidr(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _st._initial_stored_energy_from_confhd_hidr(cls, cls._c(), uow)
    @classmethod
    def _initial_stored_volume_from_pmo(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _st._initial_stored_volume_from_pmo(cls, cls._c(), uow)
    @classmethod
    def _initial_stored_volume_from_confhd_hidr(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _st._initial_stored_volume_from_confhd_hidr(cls, cls._c(), uow)
    @classmethod
    def initial_stored_energy(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _st.initial_stored_energy(cls, cls._c(), uow)
    @classmethod
    ...
    def policy_variable_units(cls, uow: AbstractUnitOfWork) -> pd.DataFrame:
        return _pol.policy_variable_units(cls, cls._c(), uow)
# fmt: on
